     ...
     <div className="flex justify-center  ">
        <Form {...form}>
            ...
            <FormField control={form.control} name="email"  render={({field})=>(
                ...
                <div className="text-sm pt-2 pb-6 font-md flex justify-center">Already have an account ? <Link className="underline ml-1 hover:text-green-400" href={"/login"}>Login</Link></div>
            </form>
        </Form>
    </div>
    </div>
